...
const FileUpload: React.FC<FileUploadProps> = ({ onFileChange }) => {
  ...
  return (
    <div
      className="bg-[#F5F5F5] py-[30px] px-[16px] rounded-[12px] h-full flex items-center justify-center border-dashed border-2 border-gray-300 transition-all duration-300"
      onDrop={handleDrop}
