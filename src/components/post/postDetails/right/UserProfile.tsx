        ...
        <div className={"flex items-center gap-[10px]"}>
          <div className={"size-[87px]"}>
            <img
              ...
              src={!owner.profileImage ? UserImage : owner.profileImage.url}
              alt={"User Image"}
            />
          </div>
          <div className={"flex-1"}>
            ...
            <button
              className={
                "mt-[16px] text-[14px] font-medium py-[10px] px-[16px] rounded-[12px] capitalize flex items-center gap-[8px] bg-[#F81539BF] text-[#fff]"
              }
            >
              <svg
                width="12"
