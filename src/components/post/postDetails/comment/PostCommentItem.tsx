...
const PostCommentItem = ({
  ...
  isParent = true,
  isFirst = false,
}: PostCommentItemPropsType) => {
  return (
    <>
      <div
        className={classNames(
          "py-[25px] px-[20px] rounded-[12px] relative w-full",
          {
      ...
      >
        <div className={"flex items-center justify-between"}>
          <div className={"flex items-center gap-[10px]"}>
            ...
            />
            <div>
              <p className={"text-[#3E3232] font-medium text-[16px]"}>
                {comment.firstname}
              </p>
          ...
          {isParent && (
            <div>
              <button
                className={
                  "hover:bg-[#3E32320F] hover:text-[#3E3232] transition-colors duration-200 ease-in-out flex items-center justify-center gap-[3px] bg-[#3E32320D] py-[12px] px-[17px] text-[#3E3232BF] font-medium text-[14px] rounded-[12px]"
                }
              >
                <svg
                  width="15"
        ...
        <>
          <div className={"relative -top-[140px] mb-[40px]"}>
            <div className={"flex flex-col justify-center"}>
              <div
                className={
                  "w-[70%] mx-auto shadow-gray-200 shadow-[0px_4px_4px_0px] rounded-[12px]"
                }
              >
