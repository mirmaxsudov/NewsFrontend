...
const Club = () => {
    return (
        <>
            <div
                className={"club rounded-[12px] py-[34px] px-[25px] h-[380px] bg-[#fff] flex justify-center items-center"}>
                <table>
                    <thead>
                    <tr>
                        <th className={"w-[150px] text-start text-[#3E3232] text-[16px] font-medium"}>Club</th>
                        <th className={"w-[50px] text-[#3E323280] text-[16px] font-medium"}>GP</th>
                        <th className={"w-[50px] text-[#3E323280] text-[16px] font-medium"}>W</th>
                        <th className={"w-[50px] text-[#3E323280] text-[16px] font-medium"}>D</th>
                        <th className={"w-[50px] text-[#3E323280] text-[16px] font-medium"}>L</th>
                        <th className={"w-[50px] text-[#3E323280] text-[16px] font-medium"}>F</th>
                        <th className={"w-[50px] text-[#3E323280] text-[16px] font-medium"}>A</th>
                        <th className={"w-[50px] text-[#3E323280] text-[16px] font-medium"}>GD</th>
                        <th className={"w-[50px] text-[#3E323280] text-[16px] font-medium"}>Pts</th>
                    </tr>
                    </thead>
                    <tbody className={"w-[150px]"}>
                    <tr>
                        <td className={"text-[#3E3232] text-[12px] font-medium flex items-center gap-2 me-[20px]"}>
                            1
                            <img
