...
const Calendar = () => {
    const data = [
        {date: 26, isNow: false},
        {date: 27, isNow: false},
        {date: <img src={Icon1} alt="icon1" className="w-5 h-5 mx-auto"/>, isNow: false},
        {date: 29, isNow: false},
        {date: 30, isNow: false},
        {date: 31, isNow: false},
        {date: 1, isNow: true},
        {date: 2, isNow: true},
        {date: 3, isNow: true},
        {date: <img src={Icon2} alt="icon2" className="w-5 h-5 mx-auto"/>, isNow: true},
        {date: 5, isNow: true},
        {date: 6, isNow: true},
        {date: 7, isNow: true},
        {date: 8, isNow: true},
        ...
        {date: 13, isNow: true},
        {date: 14, isNow: true},
        {date: <img src={Icon3} alt="icon3" className="w-5 h-5 mx-auto"/>, isNow: true},
        {date: 16, isNow: true},
        {date: 17, isNow: true},
        {date: 18, isNow: true},
        {date: <img src={Icon4} alt="icon4" className="w-5 h-5 mx-auto"/>, isNow: true},
        {date: 20, isNow: true},
        {date: 21, isNow: true},
        {date: 22, isNow: true},
        {date: 23, isNow: true},
        ...
        {date: 29, isNow: true},
        {date: 30, isNow: true},
        {date: <img src={Icon4} alt="icon4-2" className="w-5 h-5 mx-auto"/>, isNow: false},
        {date: 1, isNow: false},
        {date: 2, isNow: false},
        {date: 3, isNow: false},
        {date: 4, isNow: false},
        {date: <img src={Icon5} alt="icon5" className="w-5 h-5 mx-auto"/>, isNow: false},
    ];
                ...
                {data.map((item, index) => (
                    <div
                        ...
                        className={`p-2 rounded-full ${
                            item.isNow ? "bg-[#F3F4F6] text-black font-semibold" : "text-gray-500"
                        }`}
                    >
