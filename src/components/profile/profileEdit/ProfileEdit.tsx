...
const ProfileEdit = () => {
  ...
  if (loading) return <ProfileEditLoadingPage />;
      ...
      <section className={"profile__section mb-[50px] mt-[25px]"}>
        <div className={"container max-w-container mx-auto"}>
          ...
          <div className={"w-full my-[24px]"}>
            <span
              className={
                "text-[#3E3232] mb-[5px] text-[16px] inline-block capitalize font-medium"
              }
            >
              add banner
            </span>
            {user.bannerImage ? (
              <>
                <div
                  className={
                    "w-full h-[250px] relative transition-all duration-300"
                  }
                >
                  <img
                ...
                <button
                  ...
                  className={
                    "text-[#fff] py-1 px-3 rounded-[5px] mt-[5px] text-[16px] inline-block capitalize font-medium bg-[#F81539BF]"
                  }
                >
                  Delete
                </button>
                ...
                {user.profileImage ? (
                  <>
                    <div className={"w-full h-[300px] mt-[10px]"}>
                      <img
                        className={"size-full object-cover rounded-[12px]"}
