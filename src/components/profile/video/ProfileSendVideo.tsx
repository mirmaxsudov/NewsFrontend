    ...
    <>
      <div className={"grid grid-cols-12 gap-[24px] w-full"}>
        ...
        <div className={"col-span-3"}>
          <div>
            {/*{*/}
            {/*    // null == null ? <div className={" mb-[20px]"}>*/}
            ...
            <div className={"flex justify-between items-center mt-[20px]"}>
              <NewsButton
                className={"bg-[#F5F5F5] capitalize text-[#3E3232BF]"}
              >
                <>
                  <svg
                    width="16"
              ...
              <NewsButton className={"bg-[#F81539BF] capitalize text-[#fff]"}>
                <>
                  <svg
                    width="16"
                    height="16"
  ...
  return (
    <>
      <div className={"mt-[20px]"}>
        <h1
          className={
            "mb-[20px] font-medium text-[16px] text-[#3E3232] capitalize"
          }
        >
          Image gallery
        </h1>
        <div className={"p-[20px] rounded-[12px] bg-[#fff] shadow-md"}>
          <div className={"flex items-center gap-[26px]"}>
            <div className={"size-[319px]"}>
              <FileUpload key={uuid()} />
            </div>
            <div className={"w-full grid grid-rows-2 grid-cols-5 gap-[17px]"}>
              <ImageItem />
              <ImageItem />
              <ImageItem />
              <ImageItem />
