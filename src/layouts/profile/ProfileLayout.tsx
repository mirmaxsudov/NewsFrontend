        ...
        <>
            <section className={"profile-layout__section"}>
                <div className={"container max-w-container mx-auto"}>
                    <div className={"profile-layout__content bg-[#F5F5F5] rounded-[12px] p-[12px]"}>
                        <div className={"profile-layout__banner rounded-[12px]"}>
                            <img className={"object-cover w-full h-full rounded-[12px]"} src={ProfileLayoutBanner}
                                 alt={"Profile Banner"}/>
                        </div>
                        <div className={"flex items-center justify-between mt-[15px]"}>
                            <div className={"f flex items-center gap-[10px]"}>
                                <img className={"w-[75px] h-[75px] rounded-[12px]"} src={ProfileImage}
                                     alt={"Profile Image"}/>
                            ...
                            <div className={"m flex items-center gap-[34px]"}>
                                <NavLink className={"capitalize font-medium text-[#3E3232] profile-link"} to={"marked"}>
                                    marked
                                </NavLink>
                                <NavLink className={"capitalize font-medium text-[#3E3232] profile-link"} to={"send"}>
                                    send post
                                </NavLink>
                                <NavLink className={"capitalize font-medium text-[#3E3232] profile-link"} to={"posts"}>
                                    posts
                                </NavLink>
                            </div>
                            <div className={"l"}>
