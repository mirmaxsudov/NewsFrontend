...
import FooterCommends from "./FooterCommends.tsx";
import FollowOnInstagram from "../../../pages/about-us/FollowOnInstagram.tsx";
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-3 gap-[54px]">
                            <div className="col-span-2">
                                ...
                                <div
                                    className="flex items-center h-[40px] gap-[20px] rounded-[12px] justify-between py-[17px] px-[8px] bg-[#FFFFFF] mt-[20px]">
                                    <input
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-[15px]">
                                    <div
                                        className="istagram flex h-[40px] items-center gap-[8px] py-[13px] px-[17px] rounded-[12px] capitalize text-white text-[12px]">
                                        <svg
                                            width="14"
                                            height="13"
                                            viewBox="0 0 14 13"
                                    ...
                                    <div
                                        className="twitter size-[40px] flex justify-center items-center gap-[8px] rounded-[12px] capitalize text-white text-[12px]">
                                        <svg
                                            width="16"
                                            height="14"
                                            viewBox="0 0 16 14"
